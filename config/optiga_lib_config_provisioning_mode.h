/******************************************************************************
* File Name:   optiga_lib_config_provisioning_mode.h
*
* Description: This file is defines the compilation switches to 
*              build code with required features for the provisioning mode.
*
