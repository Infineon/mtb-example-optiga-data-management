/******************************************************************************
* File Name:   example_read_coprocessor_id.c
*
* Description: This file contains an example code to demonstarte how to reading
*              an OPTIGA Trust M co-processor ID
*
...
{
    uint8_t temp_buffer[99];
    char_t output_buffer[120];
    uint16_t index;
    ...
    for (index = 0; index < length; index+=buffer_window)
    {
        ...
        snprintf((char_t *)output_buffer, 120, "%10s%99s%10s", p_log_color, temp_buffer, OPTIGA_LIB_LOGGER_COLOR_DEFAULT);
